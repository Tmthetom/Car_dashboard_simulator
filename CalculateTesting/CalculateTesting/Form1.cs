...
namespace CalculateTesting
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            labelMin.Text = trackBarSpeed.Minimum.ToString();
            labelMax.Text = trackBarSpeed.Maximum.ToString();
            labelValue.Text = trackBarSpeed.Value.ToString();
            labelResult.Text = CalculateSpeedPolymonialRegression(trackBarSpeed.Value).ToString();
        }
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public int CalculateSpeedPolymonialRegression(int x)
        {
            /*
